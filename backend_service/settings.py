...
if IS_PROD or IS_STAGING:
    ...
    sentry_sdk.init(
        ...
        server_name=ENV.str('SERVER_NAME', default=ENV('SERVER_NAME', default='server-not-set')),
        release=ENV.str('SOURCE_VERSION', default=ENV.str('RELEASE_VERSION', default='default-release')),
...
SECRET_KEY = ENV.str('SECRET_KEY', default='^3!@kpi9pfi&lqmsh_7f_@(f*z#r!&35q836^uha3wa!$e!g@y')
...
EMAIL_BACKEND = 'django_ses.SESBackend' if IS_PROD else 'communications.services.email.EmailBackend'
...
DATA_UPLOAD_MAX_MEMORY_SIZE = ENV('DATA_UPLOAD_MAX_MEMORY_SIZE', default=104857600)  # 100 MB
DISABLE_ATTACHMENT_FILE_SIZE = ENV('DISABLE_ATTACHMENT_FILE_SIZE', default=20971520)    # 20 MB
# max limit on file size in bytes after which file must be compressed
ENFORCE_COMPRESSION_FILE_SIZE = ENV('ENFORCE_COMPRESSION_FILE_SIZE', default=5242880)    # 5 MB
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'backend_service.permissions.IsAuthenticated',
    ),
