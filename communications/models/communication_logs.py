...
class CommunicationLog(CustomModel):
    ...
    client_notification_template_name = models.CharField(
        null=True, blank=True, max_length=225
    )
    ...
    error_response = models.TextField(
        blank=True, null=True, help_text="Set when upstream provider returns an error"
    )
